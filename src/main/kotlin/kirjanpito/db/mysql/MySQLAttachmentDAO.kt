...
/**
 * MySQL-toteutus AttachmentDAO-rajapinnasta.
 * 
 * @since 2.2.0
 */
class MySQLAttachmentDAO(private val session: MySQLSession) : AttachmentDAO {
    ...
    private fun insertAttachment(attachment: Attachment): Int {
        ...
        // Get generated key using MySQL's last_insert_id()
        return try {
            session.getInsertId()
        } catch (e: SQLException) {
