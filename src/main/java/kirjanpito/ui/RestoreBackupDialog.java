 ...
 */
public class RestoreBackupDialog extends JDialog {
    ...
    public RestoreBackupDialog(Frame owner, File[] backups, BackupService backupService) {
        super(owner, "Palauta varmuuskopiosta", true);
