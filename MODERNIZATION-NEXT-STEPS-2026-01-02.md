# Modernisaation Seuraavat Askeleet - Päivitetty
...
- ✅ Voidaan parantaa UI-responsiivisuutta
...
**Muutokset:**
- Korvaa synkroninen tietokantahaku async-versiolla
...
**Huomio:** Osa model-luokista on jo Kotlinissa (`Account.kt`, `Document.kt`, jne.), mutta ne ovat data class -versioita. Tämä viittaa `models`-pakettiin, joka sisältää business-logiikkaa.
...
4. ✅ **NumberUtils → Kotlin** (1-2h)
5. ✅ **UI-testit (dialogit)** (2-3h)
...
1. **Coroutinit ensin** - Infrastruktuuri on valmis, hyvä hyödyntää se
